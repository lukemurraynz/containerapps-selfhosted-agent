...
resource arcbuild 'Microsoft.Resources/deploymentScripts@2020-10-01' = {
  ...
  properties: {
    ...
    timeout: 'PT30M'
    scriptContent: 'az acr build --registry registrycontainerluke --image adoagent:1.0  --file "Dockerfile.azure-pipelines" https://github.com/lukemurraynz/containerapps-selfhosted-agent/tree/main'
